...
__test_target__ = 'delphi.nowcast_datasetname.util.sensors_table'
...
class UnitTests(unittest.TestCase):
  ...
  def test_insert(self):
    ...
    database = MagicMock()
    target, name, location, epiweek, value = 'ov_datasetname_broad', 'wiki', 'vi', 201820, 3.14
  ...
  def test_get_most_recent_epiweek(self):
    ...
    database = MagicMock()
    target, name, location, epiweek = 'ov_datasetname_broad', 'ght', 'dc', 201820
