...
class DataSource(abc.ABC):
  ...
  def ALL_LOCATIONS(self):
    """Return a list of all locations that could possibly be referenced anywhere."""
...
class Nowcast:
  ...
  def compute_nowcast(
    ...
    H, W, output_locations = location_mapper.determine_statespace(
        input_locations, data_source, season=season, exclude_locations=exclude_locations)
...
# todo change DataSource abstract class all-caps constants to match style of pre-existing functions with similar purpose
# todo cmu-delphi/nowcast with changes in this file & perform necessary updates to make them work there
